...
endclass
  ...
  function apb_scoreboard::new(string name = "apb_scoreboard", uvm_component parent);
	...
	function apb_scoreboard::build_phase(uvm_phase phase);
  ...
  function apb_scoreboard::write_act_mon(apb_master_seq_item req);
    act_mon_queue.push_back(req);
  endfunction : write_act_mon
  
	function apb_scoreboard::write_pass_mon(apb_master_seq_item req);
