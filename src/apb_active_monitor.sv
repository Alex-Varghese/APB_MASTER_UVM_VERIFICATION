...
endclass
  ...
  function apb_active_monitor::build_phase(uvm_phase phase);
  ...
  task apb_active_monitor::monitor_inputs();  
    ...
    `uvm_info(get_type_name(), $sformatf("presetn = %0b | prdata = %0d | pslverr = %0b | pready = %0b",act_req.presetn,act_req.prdata,act_req.pslverr,act_req.pready),UVM_MEDIUM);
